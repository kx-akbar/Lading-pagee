        ...
        <section className="section-page">
          ...
          <div className="page page-1">
            ...
            <p className="text">
              ...
              intertwine with mysterious<br /> powers. <br /> Welcome to the School of the
          ...
          <div className="page page-2">
            ...
            <p className="text">
              ...
              world needs. <br /><br /> The Quest for the Lost Orb is about to begin. An
          ...
          <div className="page page-3">
            ...
            <p className="text">
              ...
              forces of darkness. <br /><br /> Darkness threatens to overwhelm the Realms.
